...
export default function HomePage() {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <h1 className="text-4xl font-bold">Welcome to Wedding App</h1>
    </div>
  );
}
...
//       <h1 className="relative z-30 text-5xl font-bold text-center mb-8 font-lavishly bg-gradient-to-r from-yellow-600 to-yellow-800 bg-clip-text text-transparent">Love Story</h1>
//       <div>
//      <Image
