...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${inter.variable} ${lavishly.variable} ${merienda.variable} ${fajardose.variable} ${fleur.variable} ${poppins.variable} antialiased`}
      >
        {children}
      </body>
    </html>
