...
const GroomCard: React.FC<GroomCardProps> = ({ 
  groomName = "Angga",
  groomFullName = "Angga Yunanda Real", 
  groomChildOrder = "1",
  ...
  const groomParent = `Putra ${getOrdinalWord(groomChildOrder)} dari Bapak ${groomFatherName} & Ibu ${groomMotherName}`;
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="relative mt-4 mb-8">
        ...
        {/* 2. border-2: Titik-titik lebih tebal/besar */}
        {/* 3. border-gold: Warna emas solid */}
        <div className="absolute -inset-2 rounded-full border-2 border-dashed border-gold animate-[spin_15s_linear_infinite]"></div>
      ...
      <ScrollReveal>
        <div className="relative text-center w-full flex flex-col items-center justify-center gap-5">
          ...
          <div className="relative px-12 py-6 group">
            ...
            <div className="absolute inset-0 w-full h-full -z-10 transform scale-110 group-hover:scale-115 transition-transform duration-700">
               <svg viewBox="0 0 400 120" preserveAspectRatio="none" className="w-full h-full drop-shadow-lg">
                 <defs>
                   {/* 1. WARNA: Gradient Emas Pekat */}
                   <linearGradient id="richGoldBrush" x1="0%" y1="0%" x2="100%" y2="0%">
                     <stop offset="0%" stopColor="#C6A664" /> 
                     <stop offset="50%" stopColor="#E5C578" /> 
                     <stop offset="100%" stopColor="#C6A664" />
                   </linearGradient>

                   {/* 2. TEKSTUR: Filter natural */}
                   <filter id="naturalBrushStroke">
                 ...
                 <path 
                   ...
                   fill="url(#richGoldBrush)"
                   filter="url(#naturalBrushStroke)" 
                   opacity="0.95"
                 />
               </svg>
            </div>
            ...
            <h1 className="text-3xl md:text-5xl font-allura text-white font-bold leading-relaxed drop-shadow-[0_2px_2px_rgba(0,0,0,0.3)] tracking-wide transform -rotate-1">
              {groomFullName}
            </h1>
          </div>
          ...
          <div className="relative">
            <div className="bg-white/50 backdrop-blur-sm border border-darkprimary px-6 py-3 shadow-md shadow-darkprimary relative">
               ...
               <p className="font-poppins text-xs font-thin text-darkprimary max-w-[280px] md:max-w-md mx-auto leading-tight uppercase tracking-wider">
                 {groomParent}
               </p>
            </div>
          </div>
