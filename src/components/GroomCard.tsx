...
const BrideCard: React.FC = () => {
  return (
    <div>
      ...
      <div className="relative w-52 h-52 bg-primary rounded-full mx-auto mt-10">
  {/* Gambar */}
  ...
  {/* <ScrollReveal>
  <div className="absolute left-1/2 transform -translate-x-1/2 text-white z-10 whitespace-nowrap">
      ...
      <ScrollReveal>
      <div className="relative text-center mt-2 text-textprimary justify-center items-center mx-8">
      <h1 className="text-3xl font-allura text-gold font-bold  ">Angga Yunanda Real</h1>
